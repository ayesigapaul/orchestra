...
This set is at **v0.3.0** and is **pre-implementation**. It supersedes the single-file v0.1 vision
...
| Client event protocol: adopt AG-UI rather than author one | [ADR-0004](adr/adr-0004-adopt-ag-ui-event-protocol.md) |
